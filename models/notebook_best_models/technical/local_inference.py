...
DEFAULT_NOTEBOOK_PATH = NOTEBOOK_DIR / "patchtst-technical-classifier.ipynb"
...
def load_ml_dependencies() -> None:
    ...
    try:
        ...
        from patchtst_lib.classification_head import PatchTSTClassifier as _PatchTSTClassifier
    except ImportError as exc:
        raise SystemExit(
            "Install local model dependencies first. For macOS CPU/MPS, run something like:\n"
            "  pip install torch torchvision torchaudio\n"
            "  pip install -r models/notebook_model_runs/technical/requirements.txt"
        ) from exc
