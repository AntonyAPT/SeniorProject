  ...
  return (
    <button
      ...
      className="group relative w-full flex items-center justify-center gap-3 
                 bg-white text-slate-900 font-semibold py-3.5 px-6 rounded-xl
                 border-2 border-slate-200
                 hover:bg-slate-50 hover:border-blue-400 hover:shadow-lg hover:shadow-blue-500/20
                 active:scale-[0.98]
    ...
    >
      ...
      {/* Hover glow effect */}
      <div
        className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500/0 via-blue-500/0 to-blue-500/0 
